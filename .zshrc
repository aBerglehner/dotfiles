...
#cheatsheets
#add them too cht
alias vimC='vim /cheatSheets/vim-cheatsheet.txt'
alias vimc='vim /cheatSheets/vim-cheatsheet.txt'
alias gitC='vim /cheatSheets/git.txt'
alias gitc='vim /cheatSheets/git.txt'
alias lC='vim /cheatSheets/linux.txt'
alias lc='vim /cheatSheets/linux.txt'
alias javaCheat='vim /cheatSheets/java.txt'
alias javacheat='vim /cheatSheets/java.txt'
alias viteC='vim /cheatSheets/vite.txt'
alias vitec='vim /cheatSheets/vite.txt'
alias restC='vim /cheatSheets/rest.txt'
alias restc='vim /cheatSheets/rest.txt'
alias npmc='vim /cheatSheets/npm.txt'
alias comg='vim /cheatSheets/commitGuide.txt'
alias comG='vim /cheatSheets/commitGuide.txt'
